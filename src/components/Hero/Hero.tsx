			...
			<hgroup>
				...
				*/}
				...
				<p className={styles["description"]}>
					<span className={styles["non-developers"]}>For non-developers: </span>
					<span>AI AI AI AI!!!!</span>
				</p>
				<p className={styles["description"]}>
					<span className={styles["developers"]}>For developers: </span>
					<span>CLI, API, NPM, REST, MCP, AI ... no escape ...</span>
				</p>
			</hgroup>
			<address>
				<ul className={styles["links__list"]}>
					...
					<li>
						<a href="https://www.linkedin.com/in/anshuman-khanna-02553b22a/" target="_blank" rel="noreferrer">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
					...
					<li>
						<a href="https://www.github.com/Anshumankhanna" target="_blank" rel="noreferrer">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
